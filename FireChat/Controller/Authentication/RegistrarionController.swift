...
class RegistrarionController: UIViewController {
    ...
    private lazy var userNameConteinerView: InputContainerView = {
        ...
        return InputContainerView(image: #imageLiteral(resourceName: "ic_person_outline_white_2x"),
                                  textField: usernameTextField)//#imageLiteral(
...
extension RegistrarionController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
...
extension RegistrarionController: AuthenticationControllerProtocol {
